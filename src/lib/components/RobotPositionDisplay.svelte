...
<script lang="ts">
  ...
  import { showTransformDialog } from "../../stores";
  ...
  <div class="flex flex-row justify-between items-center w-full">
    ...
    <div class="flex items-center gap-2">
      ...
      <button
        ...
        on:click={() => showTransformDialog.set(true)}
        class="flex flex-row items-center gap-1 hover:bg-neutral-200 dark:hover:bg-neutral-800 px-2 py-1 rounded transition-colors text-indigo-500"
      >
        <span>Transform</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
