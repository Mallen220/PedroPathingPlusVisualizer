...
>
  ...
  >
    <FolderOpenIcon className="size-4" strokeWidth={1.5} />
    Open
  </button>
  ...
  <button
    ...
    class="w-full text-left px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-200 flex items-center gap-2"
  >
    <ExportTrayIcon className="size-4" strokeWidth={1.5} />
  ...
  <button
    ...
    class="w-full text-left px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-200 flex items-center gap-2"
  >
    <DuplicateIcon className="size-4" strokeWidth={1.5} />
    Duplicate
  </button>
  ...
  <button
    ...
    class="w-full text-left px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-200 flex items-center gap-2"
  >
    <MirrorIcon className="size-4" strokeWidth={1.5} />
    Mirror Copy
  </button>
  ...
  <button
    ...
    class="w-full text-left px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-200 flex items-center gap-2"
  >
    <ReverseIcon className="size-4" strokeWidth={1.5} />
    Reverse Copy
  </button>
