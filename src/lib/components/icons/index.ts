...
export { default as SplitIcon } from "./SplitIcon.svelte";
export { default as SkipStartIcon } from "./SkipStartIcon.svelte";
export { default as SkipEndIcon } from "./SkipEndIcon.svelte";
...
export { default as PlusIconSmall } from "./PlusIconSmall.svelte";
export { default as MinusIconSmall } from "./MinusIconSmall.svelte";
export { default as SettingsIconSmall } from "./SettingsIconSmall.svelte";
...
export { default as LayerGroupIcon } from "./LayerGroupIcon.svelte";
export { default as SunIcon } from "./SunIcon.svelte";
export { default as MapPinSmallIcon } from "./MapPinSmallIcon.svelte";
export { default as EditBoxIcon } from "./EditBoxIcon.svelte";
export { default as SplitVerticalIcon } from "./SplitVerticalIcon.svelte";
export { default as CodeExportIcon } from "./CodeExportIcon.svelte";
export { default as GridSmallIcon } from "./GridSmallIcon.svelte";
export { default as RulerSmallIcon } from "./RulerSmallIcon.svelte";
export { default as OnionSkinSmallIcon } from "./OnionSkinSmallIcon.svelte";
export { default as ProtractorSmallIcon } from "./ProtractorSmallIcon.svelte";
export { default as AddPathIcon } from "./AddPathIcon.svelte";
export { default as DiscordIcon } from "./DiscordIcon.svelte";
export { default as LockRobotIcon } from "./LockRobotIcon.svelte";
...
export { default as GitModifiedIcon } from "./GitModifiedIcon.svelte";
export { default as GitStagedIcon } from "./GitStagedIcon.svelte";
export { default as GitUntrackedIcon } from "./GitUntrackedIcon.svelte";
