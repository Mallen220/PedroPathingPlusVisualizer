...
<div class="w-full space-y-4">
  ...
  {#if isRunning}
    <div class="flex gap-2">
      ...
      <button
        ...
        disabled={isStopping}
        use:tooltip="Stop the optimization process"
      >
    ...
    {#if optimizationFailed}
      <div class="flex gap-2">
        <button
          ...
          use:tooltip="Discard changes and close"
        >
          Discard
        </button>
        <button
    ...
    {:else}
      <div class="flex gap-2">
        ...
        <button
          ...
          use:tooltip="Apply the optimized path to your project"
        >
          Apply New Path
        </button>
      </div>
  ...
  {:else}
    <button
      ...
      use:tooltip="Start the path optimization process"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
