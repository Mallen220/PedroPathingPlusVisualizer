...
>
  ...
  <td class="px-3 py-2">
    <div class="relative w-full max-w-[160px]">
      <input
        class="w-full px-2 py-1 rounded border border-transparent hover:border-neutral-300 dark:hover:border-neutral-600 bg-transparent focus:bg-white dark:focus:bg-neutral-800 focus:border-teal-500 dark:focus:border-teal-500 focus:ring-2 focus:ring-teal-500 focus:outline-none text-xs transition-colors pr-6"
        value={item.name}
