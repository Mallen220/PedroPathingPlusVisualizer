...
>
  ...
  <td class="px-3 py-2">
    <div class="relative w-full max-w-[160px]">
      <input
        class="w-full px-2 py-1 rounded border border-transparent hover:border-neutral-300 dark:hover:border-neutral-600 bg-transparent focus:bg-white dark:focus:bg-neutral-800 focus:border-pink-500 dark:focus:border-pink-500 focus:ring-2 focus:ring-pink-500 focus:outline-none text-xs transition-colors pr-6"
        value={item.name}
  ...
  <td class="px-3 py-2">
    <div class="flex items-center gap-1">
      <input
        type="number"
        class="w-20 px-2 py-1 rounded border border-transparent hover:border-neutral-300 dark:hover:border-neutral-600 bg-transparent focus:bg-white dark:focus:bg-neutral-800 focus:border-pink-500 dark:focus:border-pink-500 focus:ring-2 focus:ring-pink-500 focus:outline-none transition-colors text-xs"
