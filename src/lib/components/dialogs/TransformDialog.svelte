...
<script lang="ts">
  ...
  let activeTab: "translate" | "rotate" | "flip" | "reverse" = $state("translate");
  ...
  let effectivePivotX =
    $derived(pivotMode === "center" ? 72 : pivotMode === "origin" ? 0 : customPivotX);
  let effectivePivotY =
    $derived(pivotMode === "center" ? 72 : pivotMode === "origin" ? 0 : customPivotY);
