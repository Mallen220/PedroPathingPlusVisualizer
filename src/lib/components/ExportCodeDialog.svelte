          ...
          {:else}
            ...
            >
              ...
              <button
                ...
                use:tooltip="Previous match (Shift+Enter)"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div class="flex flex-col gap-1.5">
              ...
              >
                <button
                  ...
                  use:tooltip="Generate code compatible with SolversLib"
                >
                  SolversLib
                </button>
                <button
                  ...
                  use:tooltip="Generate code compatible with NextFTC"
                >
                  NextFTC
                </button>
              </div>
      ...
      >
        ...
        <div class="flex gap-3">
          <button
            ...
            on:click={() => (isOpen = false)}
            use:tooltip="Close export dialog"
          >
            Close
          </button>
