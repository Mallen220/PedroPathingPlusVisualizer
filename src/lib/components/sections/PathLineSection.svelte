...
>
  ...
  <div class="flex items-center justify-between p-3 gap-3">
    ...
    <div class="flex items-center gap-1">
      ...
      <button
        on:click|stopPropagation={() =>
          !line.locked && onDuplicate && onDuplicate()}
        disabled={line.locked}
        class="p-1.5 rounded-md hover:bg-neutral-100 dark:hover:bg-neutral-700 text-neutral-400 transition-colors disabled:opacity-30 disabled:hover:bg-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
