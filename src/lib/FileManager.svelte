  ...
  >
    ...
    <div class="relative flex-1 overflow-hidden flex flex-col">
        ...
        {#if showAddMenu}
          ...
          >
            ...
            <button
              ...
              class="px-4 py-2 text-sm text-left text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 flex items-center gap-2"
            >
              <DocumentArrowUpIcon className="size-4 text-purple-500" />
              Import File
            </button>
            ...
            <button
              ...
              class="px-4 py-2 text-sm text-left text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-700 flex items-center gap-2"
            >
              <CodeBracketsIcon className="size-4 text-orange-500" />
              Import Java
            </button>
      ...
      {:else if filteredFiles.length === 0}
        ...
        >
          <DocumentPlusIcon className="size-12 mb-2 opacity-30 stroke-1" />
