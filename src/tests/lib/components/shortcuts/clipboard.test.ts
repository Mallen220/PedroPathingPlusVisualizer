...
import { generateName, duplicate, copy, cut, paste } from "../../../../lib/components/shortcuts/clipboard";
...
describe("clipboard", () => {
  ...
  describe("generateName", () => {
    ...
    it("should increment duplicate number if it already exists", () => {
      expect(generateName("Test duplicate", ["Test duplicate"])).toBe("Test duplicate 2");
      expect(generateName("Test duplicate", ["Test duplicate", "Test duplicate 2"])).toBe("Test duplicate 3");
    });
  });
