...
import { resetPath, handleResetPathWithConfirmation } from "../../utils/projectLifecycle";
import { isUnsaved } from "../../stores";
import { startPointStore, linesStore, sequenceStore, shapesStore } from "../../lib/projectStore";
